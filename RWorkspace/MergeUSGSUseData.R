...
getUSGSUseData <- function(year){
  theURL <- paste0('http://water.usgs.gov/watuse/data/',year,'/usco',year,'.txt')
  dataTbl = read.table(theURL, sep='\t',header=TRUE, fill=TRUE)
}
...
data2010 = getUSGSUseData(2010)
data2005 = getUSGSUseData(2005)
data2000 = getUSGSUseData(2000)

#Merge the tables
allData <- bind_rows(data2010,data2005,data2000)
