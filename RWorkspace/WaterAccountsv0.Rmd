...
## Make map data frames
```{r}
usMap <- ggplot(data = allData) + 
  geom_polygon(aes(x = long, y = lat, fill = "COUNTYFIPS"), color = "white") + 
  coord_fixed(1.3) +
  guides(fill=FALSE) 

usMap #+ scale_fill_gradient(trans = "log10")
```
